...
\todo{Let's do a 4x7 plot, but not model by model. The columns should be 13mHz, 16mHz, 19mHz, 22mHz. Stick with the same model. }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/BqE_016mHz.pdf}
