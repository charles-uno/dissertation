...
%ALEX NOTES
%## Chapter 2
%- "beyond there" doesn't sounds right, I'd be more specific with "there"
%- Ellipses seems like overkill
%### 2.1
%- What does "threaded" mean? Is that jargon?
...
Viewed from the north, the Dungey cycle involves a clockwise flow of flux and plasma on the dusk side and a counterclockwise flow on the dusk side. The motion is accompanied by a convection electric field, per \ohmlaw\footnote{In the case of an ideal plasma, \ohmlaw takes the form $\vec{E} + \vec{U} \times \vec{B} = 0$. }. 
...
The main phase of a storm typically lasts for several hours. Storm recovery --- the gradual return of the storm index to zero --- typically lasts several days. Geomagnetic storms occur tens of times per year at the height of the solar cycle, and just a few times per year otherwise. 
...
\todo{plasmaphere erosion and refilling. }

\todo{Exact location/cause of substorm onset is a topic of ongoing controversy. }

\todo{Auroral oval grows. Precipitation is enhanced. }
...
When electron density is low, thermal velocities may be unable to carry enough current to satisfy $\nabla \cdot \vec{J} = 0$. This can lead to the formation of potential structures along geomagnetic field lines in the ionosphere. 

Particles can also be accelerated by \Alfven waves. 

Acceleration of particles along magnetic field lines leads to the precipitation of energetic particles into the atmosphere. As the particles thermalize, they excite atmospheric atoms. The resulting spontaneous emission is often in the visible spectrum, giving rise to the aurora. 
