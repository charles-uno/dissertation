...
Kinetic \Alfven waves come with parallel electric fields, which should produce electron precipitation with a broad energy distribution, as has been observed. Observations are consistent with \Alfven wave models\cite{chaston_2000,chaston_2002}. 

Polar observations consistent with \Alfven waves with perpendicular scale sizes comparable to the inertial length\cite{wygant_2002}. 
