...
%ALEX NOTES
%## 3
%- I prefer 'The first' etc.
%- "precipitates into the atmosphere" what?
%- Should references be in order? They aren't in the "into the neutral
%  atmosphere" cite.
%- Not sure I like defining MLT in the footnote; you don't do it previously so
%  I have no expectation of it. I searched up the page before looking at the
%  note.
%### 3.1
%- "which its perpendicular electric field has a node." I think you mean "while
%  its"
%- I think your analogy needs some tweaking. The first "its" should probably
%  be FLR or something specific, otherwise it sounds like "the child"
%- Fig 3.2: What are the red and blue lines? I think every line needs an ID in
%  the caption.
%- "field (or the plasma velocity)" refs out of order again.
%- More refs out of order.
%### 3.2
%- I'm going to stop noting ref order; you should do a general clean up of this
%  at the end if you care.
%- **BAM** I just got smacked in the head by eq. 3.2 without warning!
%- What's a plasmapause map?
%### 3.3
%- One sentence paragraphs aren't
%- "Perhaps not coincidentally" Perhaps?
%- Fig. 3.4: I don't know how to read this plot. I guess the left is the first
%  harmonic and the right is the second, but at first glance they looked the
%  same. I guess I get it now...
%- Page 18 (page number not PDF number): You have half a sentence hanging on.
%  You should probably make this images their own page.
%### 3.4
%- What's special about Tromso Norway? I feel like you need half a sentence
%  more!
%### 3.5
%- "As summarized..." SO MANY COMMAS.
...
\begin{figure}[!htb]
    ...
    \caption[\Alfven Bounce Frequencies]{
      \todo{These are from the profiles described in \cref{sec_profile}. Note that the bounce frequency in the inner magnetosphere is highly dependent on the position of the plasmapause, taken here to be at $L=4$. }
    }
    \label{fig_fa}
\end{figure}
...
\todo{Toroidal modes show a clear frequency dependence with $L$. Poloidal modes less so. }
