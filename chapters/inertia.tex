...
A typical run has maximum $E_y$ on the order of \SI{10}{\mV/\meter\squared} and maximum $E_z$ on the order of \SI{e-3}{\mV/\meter\squared}. Notably, however, it's the electric field derivative that affects the magnetic field, not its magnitude. 
