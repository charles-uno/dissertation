...
% Note: from bob's email: The 1.88907e8 is the dielectric constant (c2/VA2) for a density of 1 cm-3 and a magnetic field of 1 nT.  eps is first calculated from the ionospheric files, and then the part associated with the plasmasphere and "auroral" densities is added in.
...
%The perpendicular component of the electric tensor, \ep, is then given by
