...
plasmapause\cite{dai_2015}. In the present work, only \todo{40} of the 451 events
\todo{(\SI{5}{\percent})} fall inside the plasmasphere, despite the fact that
...
The present chapter gives a survey of \about500 thirty-minute Pc4 events, each
