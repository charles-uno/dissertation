...
The dotted lines indicate the mean, which is listed at the top of each subplot. 
...
\todo{The nature of the relationship between \azm and the compressional coupling is not obvious. It's not linear, logarithmic, or a power law. When the compressional magnetic field is compared to the total wave magnetic field ($\sqrt{B_x^2 + B_y^2 + B_z^2}$) instead of to the poloidal magnetic field, the pattern remains unclear. }
...
\begin{figure}[!htb]
    ...
    \caption[Compressional Coupling to the Poloidal Mode: Quiet Night]{
      \todo{The other three models give comparable compressional couplings. Oddly, the quiet night profile gives twice as much. }
    }
    \label{fig_comp_4}
\end{figure}
