...
\todo{Talk about the toroidal mode. Probably $L_{PP} = 4$ is sufficient. }

\todo{Nightside. The best resonance we can get (which may be one of the $L_{drive} = 6$ runs currently happening). Poloidal. }

\todo{Also nightside toroidal. }

\todo{Briefly summarize what we see when. }
