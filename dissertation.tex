...
\include{chapters/ch_intro}
  \include{chapters/sec_environment}
  \include{chapters/sec_storms}
  \include{chapters/sec_flrs}
\endgroup

\include{chapters/ch_model}
  \include{chapters/sec_dispersion}
  \include{chapters/sec_model}
  \include{chapters/sec_inertia}

\include{chapters/ch_azm}
  \include{chapters/sec_lifetimes}
  \include{chapters/sec_layers}
  \include{chapters/sec_pgs}

\include{chapters/ch_rbsp}
  \include{chapters/sec_events}
  \include{chapters/sec_analysis}

\include{chapters/ch_conclusion}
  \include{chapters/sec_summary}
