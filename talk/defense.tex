...
\item Magnitude is estimated from the Sym-H storm index. 
\end{wideitemize}
...
\item Toroidal waves still sharper than poloidal ones, consistent with observations. 
\end{wideitemize}
\column{0.67\textwidth}
...
\item Fourier transform electric and magnetic field components. 
\item Compute Poynting flux, effective at the ionosphere. 
